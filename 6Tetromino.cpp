...
bool Tetronimos6::moveDown(Square arr[][10]) {
	bool success = false;
...
void Tetronimos6::moveLeft(Square arr[][10]) {
	sf::Color bl(50, 50, 50);
	if (orientation == 0 || orientation == 2) {
		if (x3 == 0) {
			return;
...
void Tetronimos6::moveRight(Square arr[][10]) {
	sf::Color bl(50, 50, 50);
	if (orientation == 0 || orientation == 2) {
		if (x2 == 9) {
			return;
...
void Tetronimos6::turnClockwise(Square arr[][10]) {
	sf::Color bl(50, 50, 50);
	if (orientation == 0) {
